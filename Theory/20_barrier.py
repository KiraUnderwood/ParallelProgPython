...
fist_bump = threading.Barrier(10)  # barrier which will make one thread do smth before it and other after reaching the barrier
...
def olivia_shopper():
    ...
    fist_bump.wait()  # after the action over the mutex
